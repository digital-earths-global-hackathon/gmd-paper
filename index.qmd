...
* Hackathons
  ...
  * started around 2000 ( https://www.openbsd.org/hackathons.html , https://doi.org/10.1080/14778238.2021.1911607, https://doi.org/10.1177/0162243915578486 ) 
  * original idea was to develop software projects together, usually as weekend-style activity with minimial sleep
  * Spread in all directions, with civic hacking as well as corporate hacking events
  * Gaining traction in climate research as multi-day event where scientists meet and collaborate during normal office hours and learn workflows together
    * Less about developing one piece of code together than about using the same / similar datasets and methods
    * Connecting the community
    * Forming a close link between technical and science teams
  * previouos km-scale hackathons
    * ESiWACE / DYAMOND Summer Hackathon
      * At start of km-scale modeling era
      * Started 2018 with MPI-M/DKRZ internal event, followed by an international event in June 2019 ( https://doi.org/10.5281/zenodo.3342475)
    * Then came Covid
    * nextGEMS
