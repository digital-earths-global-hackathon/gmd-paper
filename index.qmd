...
* Common catalog that unifies the interface to all datasets
* Previous intercomparisons
  * CMIP
  * DYAMOND Summer, Winter
    * Summer: 10.1186/s40645-019-0304-z 40 days of boreal summer, aligned with the NAR-VAL2 tropical field study, protocol: Stevens 2019, come as you are, no standardization
    * Winter: 40 days of boreal winter, aligned with EUREC4A campaign, coinciding with Polarstern overwintering; worked our way through to netCDF, some standardization
    * Year: doi:10.1186/s40645-024-00668-1  All datasets now are healpix/zarr -> same grid, same access.
